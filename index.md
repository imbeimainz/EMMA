...
EMMA enables the execution of Functional Enrichment Analyses using
existing tools (e.g. `clusterProfiler`, `topGO`, `gprofiler2`) while
systematically capturing analysis parameters and provenance information
during runtime, and returning enrichment results in their standard
