...
```
    ...
    #>  $ p.adjust      : num  4.33e-07 7.59e-05 7.59e-05 1.09e-04 2.26e-04 ...
    #>  $ qvalue        : num  1.22e-07 2.14e-05 2.14e-05 3.07e-05 6.37e-05 ...
    #>  $ geneID        : chr  "ENSG00000124508/ENSG00000112149/ENSG00000100368/ENSG00000205846/ENSG00000188820/ENSG00000013374/ENSG00000206503"| __truncated__ "ENSG00000124508/ENSG00000112149/ENSG00000100368/ENSG00000205846/ENSG00000188820/ENSG00000013374/ENSG00000206503"| __truncated__ "ENSG00000100368/ENSG00000205846/ENSG00000188820/ENSG00000013374/ENSG00000206503/ENSG00000204616/ENSG00000138496"| __truncated__ "ENSG00000100368/ENSG00000205846/ENSG00000206503/ENSG00000188389/ENSG00000081985/ENSG00000116514/ENSG00000019582"| __truncated__ ...
...
```
    ...
    #> Wrapper: FALSE  
    #> Package: clusterProfiler v. 4.21.1  
    #> Organism: Homo sapiens  
    #> Gene set library: GO  
...
#>  [5] mosdef_1.9.0                clusterProfiler_4.21.1     
#>  [7] org.Hs.eg.db_3.23.1         AnnotationDbi_1.75.2       
#>  [9] DESeq2_1.53.2               SummarizedExperiment_1.43.0
#> [11] Biobase_2.73.2              MatrixGenerics_1.25.0      
#> [13] matrixStats_1.5.0           GenomicRanges_1.65.1       
#> [15] Seqinfo_1.3.0               IRanges_2.47.2             
#> [17] S4Vectors_0.51.6            BiocGenerics_0.59.12       
#> [19] generics_0.1.4              macrophage_1.29.0          
#> [21] EMMA_0.99.5                 BiocStyle_2.41.0           
#> 
#> loaded via a namespace (and not attached):
#>   [1] splines_4.6.1            BiocIO_1.23.3            bitops_1.1-0            
#>   [4] ggplotify_0.1.3          filelock_1.0.3           BiasedUrn_2.0.12        
#>   [7] tibble_3.3.1             polyclip_1.10-7          enrichit_0.2.1          
#>  [10] XML_3.99-0.23            lifecycle_1.0.5          httr2_1.3.0             
#>  [13] processx_3.9.0           lattice_0.22-9           MASS_7.3-66             
...
#>  [34] ggrepel_0.9.8            tidytree_0.4.8           pkgdown_2.2.1.9000      
#>  [37] codetools_0.2-20         DelayedArray_0.39.5      DOSE_4.7.0              
#>  [40] DT_0.34.0                ggforce_0.5.0            tidyselect_1.2.1        
#>  [43] aplot_0.3.1              UCSC.utils_1.9.0         farver_2.1.2            
#>  [46] goseq_1.65.0             BiocFileCache_3.3.0      GenomicAlignments_1.49.1
#>  [49] jsonlite_2.0.0           systemfonts_1.3.2        bbmle_1.0.25.1          
#>  [52] progress_1.2.3           tools_4.6.1              ggnewscale_0.5.2        
#>  [55] treeio_1.37.0            ragg_1.5.2               Rcpp_1.1.2              
#>  [58] glue_1.8.1               SparseArray_1.13.2       BiocBaseUtils_1.15.1    
#>  [61] mgcv_1.9-4               xfun_0.60                geneLenDataBase_1.49.0  
#>  [64] qvalue_2.45.0            GenomeInfoDb_1.49.1      dplyr_1.2.1             
#>  [67] numDeriv_2016.8-1.1      withr_3.0.3              BiocManager_1.30.27     
#>  [70] fastmap_1.2.0            callr_3.8.0              digest_0.6.39           
#>  [73] R6_2.6.1                 gridGraphics_0.5-1       textshaping_1.0.5       
#>  [76] biomaRt_2.69.0           RSQLite_3.53.3           cigarillo_1.3.1         
...
#>  [94] bookdown_0.47            scales_1.4.0             png_0.1-9               
#>  [97] ggfun_0.2.1              knitr_1.51               reshape2_1.4.5          
#> [100] rjson_0.2.23             coda_0.19-4.1            nlme_3.1-170            
#> [103] curl_7.1.0               bdsmatrix_1.3-7          cachem_1.1.0            
#> [106] stringr_1.6.0            parallel_4.6.1           restfulr_0.0.17         
#> [109] desc_1.4.3               apeglm_1.35.0            pillar_1.11.1           
#> [112] grid_4.6.1               vctrs_0.7.3              tidydr_0.0.6            
#> [115] dbplyr_2.6.0             cluster_2.1.8.3          evaluate_1.0.5          
#> [118] GenomicFeatures_1.65.0   mvtnorm_1.4-2            cli_3.6.6               
#> [121] locfit_1.5-9.12          compiler_4.6.1           Rsamtools_2.29.0        
#> [124] rlang_1.3.0              crayon_1.5.3             emdbook_1.3.14          
#> [127] plyr_1.8.9               fs_2.1.0                 ggiraph_0.9.6           
#> [130] stringi_1.8.9            BiocParallel_1.47.0      txdbmaker_1.9.0         
#> [133] Biostrings_2.81.6        lazyeval_0.2.3           GOSemSim_2.39.2         
#> [136] fontquiver_0.2.1         Matrix_1.7-6             hms_1.1.4               
#> [139] patchwork_1.3.2          bit64_4.8.2              ggplot2_4.0.3           
#> [142] KEGGREST_1.53.6          igraph_2.3.3             memoise_2.0.1           
#> [145] bslib_0.12.0             ggtree_4.3.0             bit_4.6.0               
#> [148] ape_5.8-1                gson_0.2.1              
#> 
#> $extra
#> list()
#> 
...
function from the clusterProfiler package (version 4.21.1) with the GO
...
```
    ...
    #> - R                      [* -> 4.6.1]
    #> 
    #> - Lockfile written to "/var/folders/df/djsxfhc17x95674wsm_g8s980000gn/T//Rtmp4mgJ4Q/analysis.lock".
...
#>  [81] RSQLite_3.53.3              cigarillo_1.3.1            
#>  [83] tidyr_1.3.2                 renv_1.2.4                 
...
#>  [97] SingleCellExperiment_1.35.2 XVector_0.53.0             
#>  [99] htmltools_0.5.9             fontBitstreamVera_0.1.1    
#> [101] bookdown_0.47               scales_1.4.0               
#> [103] png_0.1-9                   ggfun_0.2.1                
#> [105] knitr_1.51                  reshape2_1.4.5             
#> [107] rjson_0.2.23                coda_0.19-4.1              
#> [109] nlme_3.1-170                curl_7.1.0                 
#> [111] bdsmatrix_1.3-7             cachem_1.1.0               
#> [113] stringr_1.6.0               parallel_4.6.1             
#> [115] restfulr_0.0.17             desc_1.4.3                 
#> [117] apeglm_1.35.0               pillar_1.11.1              
#> [119] grid_4.6.1                  vctrs_0.7.3                
#> [121] tidydr_0.0.6                dbplyr_2.6.0               
#> [123] cluster_2.1.8.3             evaluate_1.0.5             
#> [125] GenomicFeatures_1.65.0      mvtnorm_1.4-2              
#> [127] cli_3.6.6                   locfit_1.5-9.12            
#> [129] compiler_4.6.1              Rsamtools_2.29.0           
#> [131] rlang_1.3.0                 crayon_1.5.3               
#> [133] gprofiler2_0.2.4            emdbook_1.3.14             
#> [135] plyr_1.8.9                  fs_2.1.0                   
#> [137] writexl_2.0.0               ggiraph_0.9.6              
#> [139] stringi_1.8.9               viridisLite_0.4.3          
#> [141] BiocParallel_1.47.0         txdbmaker_1.9.0            
#> [143] Biostrings_2.81.6           lazyeval_0.2.3             
#> [145] GOSemSim_2.39.2             fontquiver_0.2.1           
#> [147] Matrix_1.7-6                hms_1.1.4                  
#> [149] patchwork_1.3.2             bit64_4.8.2                
#> [151] ggplot2_4.0.3               statmod_1.5.2              
#> [153] KEGGREST_1.53.6             igraph_2.3.3               
#> [155] memoise_2.0.1               bslib_0.12.0               
#> [157] ggtree_4.3.0                bit_4.6.0                  
#> [159] ape_5.8-1                   gson_0.2.1
```
